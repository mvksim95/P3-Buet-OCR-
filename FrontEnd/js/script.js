...
async function getFilters() {
  ...
  filtres.addEventListener('click', (e) => {
    if (e.target.tagName === 'BUTTON') { // BUTTON en maj car la valeur est toujours renvoyé en MAJUSCULE par le DOM
      filterChoice = e.target.dataset.id; // pour récupérer l'ID de la catégorie choisie
